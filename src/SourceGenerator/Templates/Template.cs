...
namespace Thor.Generator.Templates
{
    ...
    public class Template
    {
        ...
        public static Template FromFile(string fileName, string name = null)
        {
            ...
            {
                throw new FileNotFoundException(string.Format("The specified template file '{0}' does not exist.", fileName), fileName);
            }
        ...
        public static Template FromString(string template, string body)
        {
            if (template == null)
            {
            ...
            TemplateInfo templateInfo = JsonConvert.DeserializeObject<TemplateInfo>(template);
